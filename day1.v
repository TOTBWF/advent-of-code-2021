...
Module Info.
  ...
  Definition source_file := "/Users/reedmullanix/Documents/Projects/advent-of-code-2021/day1.c".
...
Definition _count_increasing : ident := $"count_increasing".
Definition _count_increasing_windowed : ident := $"count_increasing_windowed".
Definition _depths : ident := $"depths".
Definition _fopen : ident := $"fopen".
Definition _fp : ident := $"fp".
Definition _fscanf : ident := $"fscanf".
...
Definition _window_size : ident := $"window_size".
Definition _window_sum : ident := $"window_sum".
...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 114) :: Init_int8 (Int.repr 0) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v___stringlit_5 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 80) :: Init_int8 (Int.repr 97) ::
                ...
                Init_int8 (Int.repr 32) :: Init_int8 (Int.repr 50) ::
...
Definition f_count_increasing := {|
  fn_return := tuint;
  fn_callconv := cc_default;
  fn_params := ((_depths, (tptr tuint)) :: (_n, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_count, tuint) :: (_last, tuint) ::
               (_t'1, tuint) :: nil);
  fn_body :=
(Ssequence
  ...
  (Ssequence
    (Sset _last
      (Ederef
        (Ebinop Oadd (Etempvar _depths (tptr tuint))
        ...
        (Swhile
          ...
          (Ssequence
            (Ssequence
              ...
              (Sifthenelse (Ebinop Olt (Etempvar _last tuint)
...
Definition f_sum := {|
  fn_return := tuint;
  fn_callconv := cc_default;
  fn_params := ((_buf, (tptr tuint)) :: (_n, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_count, tuint) :: (_t'1, tuint) :: nil);
  fn_body :=
(Ssequence
      ...
      (Swhile
        ...
        (Ssequence
          (Ssequence
            (Sset _t'1
              (Ederef
                (Ebinop Oadd (Etempvar _buf (tptr tuint)) (Etempvar _i tint)
                  (tptr tuint)) tuint))
            (Sset _count
              (Ebinop Oadd (Etempvar _count tuint) (Etempvar _t'1 tuint)
                tuint)))
          (Sset _i
...
Definition f_count_increasing_windowed := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_depths, (tptr tuint)) :: (_n, tint) ::
                (_window_size, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_count, tint) :: (_buffer, (tptr tuint)) :: (_head, tint) ::
               (_i, tint) :: (_last, tint) :: (_i__1, tint) ::
               (_window_sum, tint) :: (_t'3, tuint) :: (_t'2, tuint) ::
               (_t'1, (tptr tvoid)) :: (_t'5, tuint) :: (_t'4, tuint) :: nil);
  fn_body :=
(Ssequence
  (Sset _count (Econst_int (Int.repr 0) tint))
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        ...
        ((Ebinop Omul (Esizeof tuint tulong) (Etempvar _window_size tint)
           tulong) :: nil))
      (Sset _buffer (Etempvar _t'1 (tptr tvoid))))
    (Ssequence
      (Sset _head (Econst_int (Int.repr 0) tint))
      (Ssequence
        (Ssequence
          (Sset _i (Econst_int (Int.repr 0) tint))
          (Sloop
            (Ssequence
              (Sifthenelse (Ebinop Olt (Etempvar _i tint)
                             (Etempvar _window_size tint) tint)
                Sskip
                Sbreak)
              (Ssequence
                (Sset _t'5
                ...
                (Sassign
                  (Ederef
                    (Ebinop Oadd (Etempvar _buffer (tptr tuint))
                      (Etempvar _i tint) (tptr tuint)) tuint)
                  (Etempvar _t'5 tuint))))
            (Sset _i
              (Ebinop Oadd (Etempvar _i tint) (Econst_int (Int.repr 1) tint)
        ...
        (Ssequence
          (Ssequence
            (Scall (Some _t'2)
              (Evar _sum (Tfunction (Tcons (tptr tuint) (Tcons tint Tnil))
                           tuint cc_default))
              ((Etempvar _buffer (tptr tuint)) ::
               (Etempvar _window_size tint) :: nil))
            (Sset _last (Etempvar _t'2 tuint)))
          (Ssequence
            (Ssequence
              (Sset _i__1 (Etempvar _window_size tint))
              (Sloop
                (Ssequence
                  ...
                  (Ssequence
                    (Ssequence
                      (Sset _t'4
                        (Ederef
                          (Ebinop Oadd (Etempvar _depths (tptr tuint))
                            (Etempvar _i__1 tint) (tptr tuint)) tuint))
                      (Sassign
                        (Ederef
                          (Ebinop Oadd (Etempvar _buffer (tptr tuint))
                            (Etempvar _head tint) (tptr tuint)) tuint)
                        (Etempvar _t'4 tuint)))
                    (Ssequence
                      (Ssequence
                        (Scall (Some _t'3)
                          ...
                          ((Etempvar _buffer (tptr tuint)) ::
                           (Etempvar _window_size tint) :: nil))
                        (Sset _window_sum (Etempvar _t'3 tuint)))
                      (Ssequence
                        (Sifthenelse (Ebinop Olt (Etempvar _last tint)
                                       (Etempvar _window_sum tint) tint)
                          (Sset _count
                          ...
                          (Sset _head
                            (Ebinop Omod
                              (Ebinop Oadd (Etempvar _head tint)
                                (Econst_int (Int.repr 1) tint) tint)
                              (Etempvar _window_size tint) tint))
                          (Sset _last (Etempvar _window_sum tint)))))))
                (Sset _i__1
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_fp, (tptr (Tstruct ___sFILE noattr))) ::
               (_depths, (tptr tuint)) :: (_head, (tptr tuint)) ::
               (_count, tint) :: (_t'5, tint) :: (_t'4, tuint) ::
      ...
      (Ssequence
        (Scall (Some _t'2)
          ...
          ((Ebinop Omul (Esizeof tint tulong)
             (Econst_int (Int.repr 2048) tint) tulong) :: nil))
        (Sset _depths (Etempvar _t'2 (tptr tvoid))))
      (Ssequence
        (Sset _head (Etempvar _depths (tptr tuint)))
        (Ssequence
          (Sset _count (Econst_int (Int.repr 0) tint))
          (Ssequence
            (Sloop
              (Ssequence
                (Ssequence
                  (Scall (Some _t'3)
                    (Evar _fscanf (Tfunction
                                    (Tcons (tptr (Tstruct ___sFILE noattr))
                                      (Tcons (tptr tschar) Tnil)) tint
                                    {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}))
                    ((Etempvar _fp (tptr (Tstruct ___sFILE noattr))) ::
                     (Evar ___stringlit_3 (tarray tschar 3)) ::
                     (Etempvar _head (tptr tuint)) :: nil))
                ...
                (Ssequence
                  (Sset _head
                    (Ebinop Oadd (Etempvar _head (tptr tuint))
            ...
            (Ssequence
              (Ssequence
                (Scall (Some _t'4)
                  (Evar _count_increasing (Tfunction
                                            (Tcons (tptr tuint)
                                              (Tcons tint Tnil)) tuint
                                            cc_default))
                  ((Etempvar _depths (tptr tuint)) ::
              ...
              (Ssequence
                (Ssequence
                  (Scall (Some _t'5)
                    (Evar _count_increasing_windowed (Tfunction
                                                       (Tcons (tptr tuint)
                                                         (Tcons tint
                                                           (Tcons tint Tnil)))
                                                       tint cc_default))
                    ((Etempvar _depths (tptr tuint)) ::
                     (Etempvar _count tint) ::
                     (Econst_int (Int.repr 3) tint) :: nil))
                  (Scall None
                    (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                                    {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                    ((Evar ___stringlit_5 (tarray tschar 12)) ::
...
((___stringlit_1, Gvar v___stringlit_1) ::
 ...
 (_fopen,
   Gfun(External (EF_external "fopen"
     ...
     (tptr (Tstruct ___sFILE noattr)) cc_default)) ::
 (_fscanf,
   Gfun(External (EF_external "fscanf"
 ...
 (_printf,
   Gfun(External (EF_external "printf"
     ...
     (Tcons (tptr tschar) Tnil) tint
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_count_increasing, Gfun(Internal f_count_increasing)) ::
 (_sum, Gfun(Internal f_sum)) ::
 (_count_increasing_windowed, Gfun(Internal f_count_increasing_windowed)) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _count_increasing_windowed :: _sum :: _count_increasing ::
 _printf :: _fscanf :: _fopen :: _malloc :: ___builtin_debug ::
